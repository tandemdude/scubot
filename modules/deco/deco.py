        ...
        for i in msg:
            if i.startswith('GFL'):
                try:
                    ...
                    await message.channel.send('Invalid parameter for GFL')
                    return
            elif i.startswith('GFH'):
                try:
                    deco_actual.GFHigh = float(i.replace('GFH', '')) / 100  # Divide by 100 to make decimal form
                except:
                    await message.channel.send('Invalid parameter for GFH')
                    return
            elif i.startswith('G'):
                try:
                    ...
                    await message.channel.send('Invalid parameter for Gas')
                    return
            elif i.startswith('D'):
                try:
                    ...
                    await message.channel.send('Invalid parameter for Dive Profile')
                    return
